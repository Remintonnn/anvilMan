...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(900, 852)
        font = QFont()
        font.setBold(False)
        MainWindow.setFont(font)
        MainWindow.setAutoFillBackground(False)
        MainWindow.setStyleSheet(u"/*====== The Test Zone Above ======*/\n"
"\n"
"\n"
"\n"
"QFrame {\n"
...
"}")
        ...
        self.saveTable.setGeometry(QRect(10, 24, 251, 288))
        ...
        self.enchSelFrame.setGeometry(QRect(610, 10, 281, 811))
...
"}")
        ...
        self.generatePendingBookButton.setGeometry(QRect(130, 770, 141, 31))
...
"}")
        ...
        self.pendingBookFram.setGeometry(QRect(10, 420, 591, 401))
        ...
        self.pendingBookTable.horizontalHeader().setVisible(True)
        self.pendingBookTable.horizontalHeader().setCascadingSectionResizes(False)
        ...
        self.calculateInstructionButton.setGeometry(QRect(440, 360, 141, 31))
...
"}")
        ...
        self.pendingBookAdvencedEditButton.setGeometry(QRect(340, 360, 91, 31))
        ...
        self.saveButton.setGeometry(QRect(250, 360, 81, 31))
        ...
        self.saveNameInputBox.setGeometry(QRect(10, 360, 231, 31))
        font4 = QFont()
